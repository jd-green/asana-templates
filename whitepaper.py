...
# using the Whitepaper template


def create_whitepaper(client, number, total):
    data1 = """
    {"data": {
            "name": "[tmp] ($num/$tot) Whitepaper",
    ...
    try:
        response = requests.post(
            url="https://app.asana.com/api/1.0/projects/1144459528826341/duplicate",
            headers={
