...
def create_gg_tech_brief(client, number, total):
    data1 = """
    {"data": {
            "name": "[tmp] ($num/$tot) Gorilla Guide Tech Brief",
    ...
    try:
        response = requests.post(
            url="https://app.asana.com/api/1.0/projects/1170248129552996/duplicate",
            headers={
